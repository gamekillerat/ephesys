...
void Features::SuperJumpUltra(bool toggle)
{
		...
		{
			{
				...
				while (loops > 0 || rest > 0)
				{
					...
					if (UNK3::_NETWORK_SHOP_BEGIN_SERVICE(&money, 1474183246, remove ? -1359375127 : -1586170317, remove ? 537254313 : 1445302971, amount, 4))
...
void Features::setName(char* name) {
...
void Features::OffRadar(bool toggle)
{
	if (toggle == true)
	{
		globalHandle(2423801 + 1 + PLAYER::PLAYER_ID() * 413 + 200).As<bool>() = true;
		globalHandle(2437022 + 70).As<int>() = NETWORK::GET_NETWORK_TIME() + 9999999999;
	}
	else
	{
		globalHandle(2423801 + 1 + PLAYER::PLAYER_ID() * 413 + 200).As<bool>() = true;
...
bool Features::forceog = false;
void Features::force(bool toggle)
{
